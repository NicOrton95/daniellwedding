...
<body>
        ...
        <div class="body">
            ...
            <div id="wedding-details-container">
                <div class="wedding-details-one-container">
                    ...
                    <br/>
                    <h3 class="section-details">Reception: blah blah make up content here</h3>
                    <br/>
    ...
    <div id="big-bg">
            ...
            <div id="start-gal-cont"><h1 class="section-heading gal-heading">Gallery</h1>
                ...
                <img src="images/gallery/wedding-gallery15-resize.jpg" alt="weddingpic" id="galleryimg15">
                </div>
            </div>
            <div class="general-spacer"></div>
            <div id="our-story-container">
                <div id="inside-our-story">
                    ...
                    <br/>
                    <p class="section-details">Just like all fairytales, this one begins with once upon a time...</p>
                    <br/>
                    <p class="section-details">Once upon a time long ago far far away a king & queen had a beautiful daughter named Fiona</p>
                    <br/>
                    <p class="section-details">She was waiting for a prince but instead got rescued by Shrek</p>
                    <br/>
                    <p class="section-details">And the kingdom of far far away was finally at peace. They lived happily ever after.</p>
                </div>
            </div>
            <div class="general-spacer"></div>
